...
| `shellcheck` | 全 staged | `configs/wm/sketchybar/.*`、`\.envrc$`、`\.zsh$`、`configs/macmini/bin/.*`、`configs/macmini/client/.*`、`configs/macmini/setup-scripts/.*` | shell lint (.shellcheckrc に従う) |
<!-- END hooks -->
