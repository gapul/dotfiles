...
| `nixsh` (on the remote) | Shared Linux box without sudo: native-speed Nix in a rootless-docker container. `nixsh update` rebuilds the package set of `.#<user>-linux-shared` |
