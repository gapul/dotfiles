...

{
  ...
  systemd.targets."podman-compose-archivebox-root" = {
    unitConfig = {
      ...
      # This legacy compose target is no longer the lifecycle owner. If an old
      # generation leaves it active, do not let the next NixOS switch wake the
      # container outside lazy-archivebox.target.
