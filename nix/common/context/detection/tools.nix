  ...
  config = mkIf config.dotfiles.context.toolConfiguration.enable {
    environment.systemPackages = with pkgs; [
      ...
      (writeShellScriptBin "context-configure-tools" ''
        ...
        ${optionalString config.dotfiles.context.toolConfiguration.developerProfiles.enable ''
        ...
        ${optionalString config.dotfiles.context.toolConfiguration.editorIntegration.enable ''
...
EOF
        ...
        ${optionalString config.dotfiles.context.toolConfiguration.terminalOptimization.enable ''
...
EOF
        ...
        ${optionalString config.dotfiles.context.toolConfiguration.toolchainManagement.enable ''
          configure_toolchain() {
            local profile="$1"
