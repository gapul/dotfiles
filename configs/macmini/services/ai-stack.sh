...
while true; do
  # Python系サービス
  pgrep -f "ollama serve" >/dev/null || (export OLLAMA_HOST="$AI_BIND_ADDR:11434" OLLAMA_KEEP_ALIVE=5m OLLAMA_MAX_LOADED_MODELS=1; nohup ollama serve >/tmp/ollama.log 2>&1 &)
